# Кастомный коннектор к Яндекс.Маркет для Power BI
...
1) Скачайте файл MEZ: https://github.com/morinad/yandex_market_pq/raw/main/YandexMarket.mez
...
4) Нажмите на кнопку "Получить данные", в поиске введите "Market" и выберите коннектор Yandex Market Connector.


### Полезные ссылки:
Подробная инструкция по использованию коннектора: http://directprobi.ru/blogs/api-yandex-market-excel-power-bi-connector-partner-integraciya-zakazy-orders-products-fbs/
